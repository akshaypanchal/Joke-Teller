...
function tellMeJokes (joke){
    VoiceRSS.speech({
        key: '3d6b4943817b411a800d1e1bc0bec3ad',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes(){
    ...
    try{
        ...
        // Calling the enable button function
        toggleButton();

        // Calling the tellMeJoke function
        tellMeJokes(joke);
    }
    catch(error){
        // catch errors!!
